...
It should choose a random number between 1 and 100, then 
...
The game will end once the player guesses correctly, or once they 
run out of turns. When the game ends, the player should be given an 
